...
const Landing: React.FC = () => {
  return (
    <div className="h-screen flex flex-col bg-blurple">
      ...
      <div className="grid grid-cols-12 w-screen min-h-[500px] grow px-8 pb-8 pt-16 gap-4">
        ...
        <div className="col-start-9 col-span-4 flex flex-col items-center justify-end h-full min-h-0 pt-[20%]">
